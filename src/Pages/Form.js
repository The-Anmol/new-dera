...
const Form = () => {
  ...
  // var certificate1 = "https://img.icons8.com/ios/50/000000/certificate.png";
  // var certificate2 = "https://img.icons8.com/ios/50/000000/certificate.png";
  ...
  //   student = "https://img.icons8.com/material-rounded/48/000000/checkmark--v1.png";
  //   document = "https://img.icons8.com/material-rounded/48/000000/checkmark--v1.png";
  //   certificate1 = "https://img.icons8.com/material-rounded/48/000000/checkmark--v1.png";
  // }
  // if (currentTab === "Sewa") {
  //   userIcon = "https://img.icons8.com/material-rounded/48/000000/checkmark--v1.png";
  //   student = "https://img.icons8.com/material-rounded/48/000000/checkmark--v1.png";
  //   document = "https://img.icons8.com/material-rounded/48/000000/checkmark--v1.png";
  //   certificate1 = "https://img.icons8.com/material-rounded/48/000000/checkmark--v1.png";
  //   certificate2 = "https://img.icons8.com/material-rounded/48/000000/checkmark--v1.png";
  // }
  ...
  return (
    <>
      <div className={`flex flex-col p-1 items-center min-h-screen bg-gray-100 sm:p-8 md:w-screen justify-evenly   `} >
        {/* Stepper Line */}
        {/* <div className='z-10 items-center justify-between hidden w-11/12 h-1 mx-auto mt-6 mb-24 rounded-md text-bg-gray-900 md:w-11/12 lg:w-full xl:w-10/12 2xl:w-6/12 2xsm:flex stepper-line '>
          <div className='h-10 p-2 after:hidden md:after:block md:h-16 rounded-xl aspect-square steps ' >
            <img className='m-0' alt='User' src={userIcon} />
          </div>
          <div className='h-10 p-2 after:hidden md:after:block md:h-16 rounded-xl aspect-square steps ' >
            <img src={student} alt="student" />
          </div>
          <div className='h-10 p-2 md:h-16 after:hidden md:after:block rounded-xl aspect-square steps ' >
            <img className='m-0' alt='Form' src={document} />
          </div>
          <div className='h-10 p-2 md:h-16 after:hidden md:after:block rounded-xl aspect-square steps ' >
            <img alt='Qualification' src={certificate1} />
          </div>
          <div className='h-10 p-2 md:h-16 after:hidden md:after:block rounded-xl aspect-square steps ' >
            <img alt='Qualification' src={certificate2} />
          </div>
          <div className='h-10 p-2 md:h-16 after:hidden md:after:block rounded-xl aspect-square steps ' >
            <img alt='Sewa' src={wellFare} />
          </div>
        </div> */}
        <h1 className="flex justify-between mx-auto my-4 text-2xl font-semibold text-center text-gray-700 ">Ex-student Biodata Collection </h1>

        <div className={` h-fit z-20  flex-col flex-1 px-1 sm:px-0 overflow-hidden body rounded-md shadow-lg md:w-11/12 lg:w-10/12 xl:w-8/12 2xl:w-6/12 w-96 max md:flex-1  ${currentTab === "1" ? "flex" : "hidden"} lg:max-w-screen-lg`} >
          ...
          <div className='flex w-full gap-4 m-auto mb-4 sm:w-6/12'>
            <span className='mb-4'>
              <div className='flex justify-center'>
                <button onClick={ () => {changeTab("2")} } type="submit" className="flex px-6 py-2 text-lg font-semibold text-center text-white transition-colors duration-300 bg-blue-500 rounded-md shadow w-max hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4">
                  Next
                </button>
              </div>
            </span>
          ...
          <div className={`z-20 h-fit shrink flex-col px-1 sm:px-0 overflow-hidden bg-white rounded-md shadow-lg md:w-11/12 lg:w-10/12 xl:w-8/12 2xl:w-6/12 w-96  ${ currentTab === "2" ? "flex" : "hidden"} lg:max-w-screen-lg `} >
            {/* Ex-student Details */}
            <div className="p-5 md:flex-1">
            ...
            <div className='flex w-full gap-4 m-auto mb-4 sm:w-6/12'>
              ...
              <span className='m-auto'>
                <div className='flex justify-center'>
                  <button onClick={() => { changeTab("3") }} type="submit" className="flex px-6 py-2 text-lg font-semibold text-center transition-colors duration-300 bg-blue-500 rounded-md shadow btns w-max hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4">
                    {buttonNext}
                  </button>
                </div>
              </span>
          ...
          <div className={`h-fit z-20 flex-col shrink flex px-1 sm:px-0 overflow-hidden bg-white rounded-md shadow-lg md:w-11/12 lg:w-10/12 xl:w-8/12 2xl:w-6/12 w-96 ${currentTab === "3" ? "flex" : "hidden"} lg:max-w-screen-lg`} >
            ...
            <div className='flex w-full gap-4 m-auto mb-4 sm:w-6/12'>
              <span className='m-auto'>
                <div className='flex justify-center'>
                  <button onClick={() => changeTab("2")} type="submit" className="flex px-6 py-2 text-lg font-semibold text-center text-white transition-colors duration-300 bg-blue-500 rounded-md shadow btns w-max hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4">
                    {buttonPrevious}
                  </button>
                </div>
              </span>
              <span className='m-auto'>
                <div className='flex justify-center'>
                  <button onClick={() => changeTab("4")} type="submit" className="flex px-6 py-2 text-lg font-semibold text-center text-white transition-colors duration-300 bg-blue-500 rounded-md shadow btns w-max hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4">
                    {buttonNext}
                  </button>
                </div>
              </span>
          ...
          <div className={`h-fit z-20 flex-col shrink flex-1 px-1 sm:px-0 overflow-hidden bg-white rounded-md shadow-lg md:w-11/12 lg:w-10/12 xl:w-8/12 2xl:w-6/12 w-96 ${currentTab === "4" ? "flex" : "hidden"} lg:max-w-screen-lg`} >
            ...
            <span className='m-auto'>
              <div className='flex justify-center'>
                <button onClick={() => changeTab("3")} type="submit" className="flex px-6 py-2 text-lg font-semibold text-center text-white transition-colors duration-300 bg-blue-500 rounded-md shadow btns w-max hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4">
                  {buttonPrevious}
                </button>
              </div>
            </span>
            <span className='m-auto'>
              <div className='flex justify-center'>
                <button onClick={() => changeTab("5")} type="submit" className="flex px-6 py-2 text-lg font-semibold text-center text-white transition-colors duration-300 bg-blue-500 rounded-md shadow btns w-max hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4">
                  {buttonNext}
                </button>
              </div>
            </span>
          ...
          <div className={`h-fit z-20 flex-col shrink flex-1 px-1 sm:px-0 overflow-hidden bg-white rounded-md shadow-lg md:w-11/12 lg:w-10/12 xl:w-8/12 2xl:w-6/12 w-96 ${currentTab === "5" ? "flex" : "hidden"} lg:max-w-screen-lg`} >
            ...
            <span className='m-auto'>
              <div className='flex justify-center'>
                <button onClick={() => changeTab("6")} type="submit" className="flex px-6 py-2 text-lg font-semibold text-center text-white transition-colors duration-300 bg-blue-500 rounded-md shadow btns w-max hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4">
                  {buttonNext}
                </button>
              </div>
            </span>
          ...
          <div className={`h-fit z-20 flex-col shrink flex-1 px-1 sm:px-0 overflow-hidden bg-white rounded-md shadow-lg md:w-11/12 lg:w-10/12 xl:w-8/12 2xl:w-6/12 w-96 ${currentTab === "6" ? "flex" : "hidden"} lg:max-w-screen-lg`} >
            {/* Sewa Details*/}
